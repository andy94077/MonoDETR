...
class DDNWithWeightedDepthLoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.weighted_depth_criterion = RegressionFocalLoss(alpha=self.alpha, gamma=self.gamma, norm='l1', reduction='none')
    ...
    def forward(self, depth_logits, weighted_depth, gt_boxes2d, num_gt_per_img, gt_center_depth):
        ...
        weighted_depth_loss = self.weighted_depth_criterion(depth_logits, weighted_depth, depth_target, depth_map_values)
        ...
        return depth_map_loss, weighted_depth_loss
